...
const TechEvents = () => {
  return (
    <div className="min-h-screen bg-[#050814] text-white relative overflow-hidden">
      {/* Background Stars */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,#1b2a4e,transparent_40%),radial-gradient(circle_at_80%_80%,#2d0b59,transparent_40%)] opacity-70" />

      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16">
        {/* Title */}
        <h1 className="text-center text-5xl md:text-6xl font-extrabold tracking-wide text-cyan-400">
          Technical Events
        </h1>
        ...
        <div className="mt-10 flex justify-center">
          <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-400/30 rounded-xl px-8 py-5 backdrop-blur">
            <p className="text-lg text-center">
              🏆 <span className="text-cyan-300 font-semibold">Winner:</span> ₹1,000
              &nbsp; | &nbsp;
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-12">
          {events.map((event, index) => (
            <div
              key={index}
              className="group bg-black/40 border border-white/10 rounded-2xl overflow-hidden backdrop-blur-xl hover:border-cyan-400/50 transition duration-500 shadow-[0_0_40px_rgba(0,255,255,0.05)]"
            >
              {/* Image */}
              ...
              <div className="p-6">
                ...
                <div className="mt-6 flex gap-4">
                  ...
                  <button className="flex-1 bg-gradient-to-r from-cyan-500 to-purple-600 text-black font-semibold py-2 rounded-lg hover:opacity-90 transition">
                    Register Now →
                  </button>
                </div>
              </div>
