  ...
  return (
    <div className="rounded-lg p-1">
      <div className="flex items-center justify-center gap-4">
        ...
        <div className="relative w-full rounded-2xl p-[2px] overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-cyan-400/80 via-blue-500/60 to-purple-500/80" />
          <div className={`relative flex items-start flex-col justify-center rounded-2xl bg-bg-primary backdrop-blur-md px-6 py-4 ${minH}`}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="relative flex items-center justify-center">
            <div className="fixed top-20 -left-48 opacity-50"><img src="src/assets/robo.png" alt="" className="max-w-max" /></div>

            <form onSubmit={handleSubmit} className="flex flex-col items-center gap-5 min-w-max z-50 md:flex-row md:absolute md:left-64 md:-top-10 md:max-h-[95vh] sm:max-h-[90vh]">
              <div className="bg-bg-secondary/50 rounded-3xl px-8 py-5">
                <div className="flex items-center justify-center h-10 mb-7"><h3 className="text-4xl text-center font-bold text-cyan-300">Directly contact US</h3></div>
                {contactCards.map((card) => (<ContactCard key={card.title} title={card.title} text={card.text} minH={card.minH} svg={card.svg} />))}
              </div>
              ...
              <div className="max-w-lg bg-bg-secondary/50 rounded-3xl py-6 pb-4 px-10">
                ...
                {submitted && (<div className="bg-green-500/20 border border-green-400 rounded-lg p-4 text-green-300 font-semibold fade-in">✓ Message sent successfully! We'll respond within 24 hours.</div>)}
