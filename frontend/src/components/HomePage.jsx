...
export default function HomePage() {
  ...
  return (
    ...
    style={{
      ...
      {/* Content */}
<div className="relative z-10 flex flex-col md:flex-row items-center md:items-center justify-between h-screen px-6 md:px-16">
  ...
  >
    <img
      src={aiBg2} // 🔁 replace if you want another image
